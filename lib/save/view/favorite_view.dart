...
class _ShoeLibraryScreenState extends State<ShoeLibraryScreen> {
  ...
  List<Collection> myCollections = [
    ...
    Collection(
      ...
      imageUrl: "https://img.freepik.com/free-photo/leather-shoes_1203-8120.jpg?w=900",
    ),
    Collection(
      id: '3',
      title: "Jordan Retro",
      ...
      imageUrl: "https://static.nike.com/a/images/t_PDP_1280_v1/f_auto,q_auto:eco/5a709085-3b02-463d-8e8e-c9062334863b/air-jordan-1-mid-se-shoes-Zn07hL.png",
    ),
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xFFF9F9F9), // لون أبيض مائل للرمادي قليلاً للراحة
      body: SafeArea(
        child: Padding(
  ...
  Widget _buildCollectionCard(Collection item, int index) {
    return Dismissible(
      ...
      background: Container(
        ...
        child: Icon(Icons.delete_outline_rounded, color: Colors.red[400], size: 28.sp),
      ),
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: Colors.white,
          borderRadius: BorderRadius.circular(20.r),
          border: Border.all(color: Colors.grey.withOpacity(0.1)), // حدود خفيفة بدلاً من الظل القوي
          boxShadow: [
            BoxShadow(
                  ...
                  child: ClipRRect(
                    ...
                    child: Image.network(
                      ...
                      errorBuilder: (context, error, stackTrace) {
                        return Center(
                          child: Icon(Icons.image_not_supported_outlined, color: Colors.grey[400], size: 24.sp),
                        );
                      },
          ...
          child: Column(
            ...
            children: [
              ...
              TextField(
                ...
                autofocus: true,
                style: GoogleFonts.dmSans(color: Colors.black, fontWeight: FontWeight.w500),
